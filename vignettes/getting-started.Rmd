...
rating.table <- data.frame(CI, rating, defn, 
                           stringsAsFactors = F, 
                           row.names = NULL)
#row.names(rating.table) = stringr::str_wrap(row.names(rating.table), width=50)
...
![alt text](_put your file path here_ "Put your caption in quotes here")
```
...
```{markdown}
First give your picture a name and then designate the file location and HTML caption

[logo]: _put your file path here_ "Put your caption in quotes here"
