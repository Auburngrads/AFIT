...
& & & & & \multirow{3}{0.4\textwidth}{\parbox[][0.5\rhXII][t]{0.4\textwidth}{\vspace{-10pt}
 ...
 \textField[\textSize{10}\TU{ }\V{$if(advisor.phone)$$advisor.phone$$else$937-255-3636 x0000$endif$; $if(advisor.email)$$advisor.email$$else$email@afit.edu$endif$}]{sf19b}{.4\textwidth}{0.4cm}}}\\
& & & & & \\
& & & & & \\ \cline{1-6}
 \end{tabular}}
\end{document}