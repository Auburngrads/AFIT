...
\MakeUppercase{fIrSt ThInGs FiRsT} - \underline{this IS your thesis}.  As you start writing your document, you will replace this example content with your own.  This document is meant to serve as a shell for your thesis and a primer on how to use Markdown.  Throughout this document, you will find several references to resources showing how to include
...
It's really easy to go from a `matrix` or a `data.frame` to a \LaTeX-style table in under 5 seconds
